...
export interface ApiKonselorKonselor extends Struct.CollectionTypeSchema {
  collectionName: 'konselors';
  info: {
    displayName: 'Konselor';
    pluralName: 'konselors';
    singularName: 'konselor';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::konselor.konselor'
    > &
      Schema.Attribute.Private;
    nama: Schema.Attribute.String;
    profil: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMedicalRecordMedicalRecord
  ...
  attributes: {
    ...
    isFilled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiRiwayatRiwayat extends Struct.CollectionTypeSchema {
  collectionName: 'riwayats';
  info: {
    displayName: 'Riwayat';
    pluralName: 'riwayats';
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    avatarId: Schema.Attribute.Integer;
    ...
    publishedAt: Schema.Attribute.DateTime;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    riwayats: Schema.Attribute.Relation<'oneToMany', 'api::riwayat.riwayat'>;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::riwayat.riwayat': ApiRiwayatRiwayat;
